...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp11()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp12(MP.UI.ICell p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(MPScrollViewDataSource.ActGetCount))
			{
			    return new MPScrollViewDataSource.ActGetCount(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(MPScrollViewDataSource.ActSetCell))
			{
			    return new MPScrollViewDataSource.ActSetCell(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(MPScrollViewDataSource.ActOnPressTheRoomInfoBtn))
			{
			    return new MPScrollViewDataSource.ActOnPressTheRoomInfoBtn(__Gen_Delegate_Imp13);
			}
