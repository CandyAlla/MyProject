    ...
    public class XLuaTestLuaBehaviourWrap 
    {
        ...
        static int _s_set_injections(RealStatePtr L)
        {
		    try {
                ...
                XLuaTest.LuaBehaviour gen_to_be_invoked = (XLuaTest.LuaBehaviour)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.injections = (System.Collections.Generic.List<XLuaTest.Injection>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<XLuaTest.Injection>));
